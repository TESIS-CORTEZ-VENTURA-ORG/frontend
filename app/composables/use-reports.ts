...
export function useCashierDashboard(enabled?: MaybeRefOrGetter<boolean>) {
  return useQuery({
    ...
    query: () => $fetch<ApiResponse<CashierDashboardView>>('/api/reports/dashboard/cashier').then(r => r.data),
  })
}
...
export function useManagerDashboard(enabled?: MaybeRefOrGetter<boolean>) {
  return useQuery({
    ...
    enabled: enabledGetter(enabled),
    query: () => $fetch<ApiResponse<ManagerDashboardView>>('/api/reports/dashboard/manager').then(r => r.data),
  })
}
...
export function useAdminDashboard(enabled?: MaybeRefOrGetter<boolean>) {
  return useQuery({
    ...
    enabled: enabledGetter(enabled),
    query: () => $fetch<ApiResponse<AdminDashboardView>>('/api/reports/dashboard/admin').then(r => r.data),
  })
}
...
export function useParetoDishes(
  ...
  return useQuery({
    ...
    query: () => {
      const w = toValue(window)
      return $fetch<ApiResponse<ParetoReportView>>('/api/reports/pareto-dishes', {
...
export function useInventoryReport(enabled?: MaybeRefOrGetter<boolean>) {
  return useQuery({
    ...
    enabled: enabledGetter(enabled),
    query: () => $fetch<ApiResponse<InventoryReportView>>('/api/reports/inventory').then(r => r.data),
  })
}
...
export function useFoodCostReport(
  ...
  return useQuery({
    ...
    enabled: enabledGetter(enabled),
    query: () => $fetch<ApiResponse<FoodCostReportView>>('/api/reports/food-cost', {

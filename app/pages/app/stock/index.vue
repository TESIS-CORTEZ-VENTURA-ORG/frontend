...
<template>
  <div class="stk-screen">
    ...
    <section class="stk-action-grid" aria-label="Acciones principales">
      <NuxtLink to="/app/stock/shopping-list" class="stk-action">
      ...
      <NuxtLink to="/app/data/magic-upload" class="stk-action featured">
        <span class="stk-action-arrow" aria-hidden="true"><UIcon name="i-lucide-arrow-up-right" /></span>
      ...
      <NuxtLink to="/app/stock/movements" class="stk-action">
        <span class="stk-action-arrow" aria-hidden="true"><UIcon name="i-lucide-arrow-up-right" /></span>
      ...
      <NuxtLink to="/app/stock/move" class="stk-action">
        <span class="stk-action-arrow" aria-hidden="true"><UIcon name="i-lucide-arrow-up-right" /></span>
    ...
    <section v-if="critical.length" class="stk-section" aria-label="Insumos críticos">
      <div class="stk-section-head">
        ...
        <NuxtLink to="/app/stock/shopping-list" class="stk-section-link">
      ...
      <div class="stk-critical-list">
        <div
          ...
          @click="navigateTo(`/app/stock/product/${c.id}`)"
        >

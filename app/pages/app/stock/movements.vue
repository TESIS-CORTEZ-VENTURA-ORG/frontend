...
<template>
  <div class="mv-screen">
    <UiScreenHeader title="Movimientos" subtitle="Historial de entradas y salidas" back="/app/stock">
      <template #trailing>
        <UButton to="/app/stock/move" icon="i-lucide-plus" size="sm" color="primary">Registrar</UButton>
      </template>
    </UiScreenHeader>
    ...
    >
      <UButton to="/app/stock/move" icon="i-lucide-plus">Registrar movimiento</UButton>
    </UiEmptyState>
  </div>
</template>

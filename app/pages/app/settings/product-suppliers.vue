...
<template>
  <div class="cat-screen">
    <UiScreenHeader title="Insumos y proveedores" subtitle="Vínculo insumo ↔ proveedor" back="/app/settings" />
    ...
    <template v-if="ingredientId">
      ...
      <p v-if="!readonly && supplierList.length === 0" class="ps-warn">
        ...
        No tienes proveedores aún. Créalos en <NuxtLink to="/app/settings/suppliers">Proveedores</NuxtLink>.
      </p>
    </template>

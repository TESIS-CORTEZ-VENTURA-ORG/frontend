...
- 🔲 **Sin pantalla aún (backend listo, UI pendiente — diferido por decisión):** admin de **unidades** (HU-02-03), **proveedores** (HU-02-05/06) y **categorías de insumo** (HU-02-04). Son secciones de administración nuevas que el prototipo no tenía; se retoman como bloque admin.

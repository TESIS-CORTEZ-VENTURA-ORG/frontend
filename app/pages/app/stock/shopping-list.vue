...
<template>
  <div class="sl-screen">
    <UiScreenHeader title="Lista de Compras" :subtitle="dateLabel" back="/app/stock">
      <template #trailing>
      ...
      <div v-if="pending.length" class="sl-list">
        ...
        >
          ...
          <div v-if="expanded === item.id" class="sl-item-detail" @click.stop>
            ...
            <NuxtLink :to="`/app/stock/product/${item.ingredientId}`" class="sl-detail-link">

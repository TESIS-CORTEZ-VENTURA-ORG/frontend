...
<template>
  <div class="mu-screen">
    <UiScreenHeader title="Magic Upload" subtitle="Escanea facturas con IA" back="/app/stock" />
    ...
    <template v-else-if="phase === 'done'">
      <section class="mu-done">
        ...
        <div class="mu-done-actions">
          <UButton to="/app/stock" size="xl" block icon="i-lucide-package">Ver inventario</UButton>

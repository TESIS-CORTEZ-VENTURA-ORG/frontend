...
<template>
  <div class="cat-screen">
    <UiScreenHeader title="Proveedores" :subtitle="`${all.length} proveedores`" back="/app/settings">
      <template #trailing>
    ...
    <p class="cat-intro link-hint">
      ...
      ¿Necesitas vincular un insumo con su proveedor y precio? Hazlo desde el <NuxtLink to="/app/settings/product-suppliers">vínculo insumo ↔ proveedor</NuxtLink>.
    </p>
